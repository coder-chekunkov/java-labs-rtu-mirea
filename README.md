...
Данные лабораторные работы проводились в рамках дисциплины "Кроссплатформенная среда исполнения программного обеспечения" в 1-ом семестре 2-ого курса.

Дисципилна была защищена на оценку: "отлично".

С технической документацией Вы можете ознакомится на страницах Wiki.

Так же, вне учебного процесса, данные лабораторные работы были выполнены на языке программирования Kotlin.
